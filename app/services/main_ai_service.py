...
TOOL_INSTRUCTIONS = (
    ...
    "реальные имена мастеров из результата (например 'Свободны Иван и "
    "Мария'). НИКОГДА не отвечай на такой вопрос шаблонной фразой вроде "
    ...
    "например: 'Ждём вас! Ваш мастер — Мария ✨' (бери имя именно из "
